namespace :db do
  ...
  task design: :environment do
    ...
    coffee_files = Dir.glob File.join design_dir, '**', '*.coffee'
    js_files = Dir.glob File.join design_dir, '**', '*.js'

    data = {}

    files = coffee_files | js_files
    ...
    files.each do |filename|
      ...
      vd = data[design_doc_name] ||= { 'views' => {}, 'filters' => {}, 'lists' => {}, 'lib' => {}, 'indexes' => {}}
